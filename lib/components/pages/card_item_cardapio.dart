                    ...
                    child: ClipPath(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            //Nome do Produto
                            textoCardProduto( produto.getNome(), 0.03, FontWeight.w400, 1, Colors.grey[700] ),
                            //Preço do Produto
                            textoCardProduto( 'R\$ ${produto.getPreco().toString()}', 0.025, FontWeight.w400, 1, Colors.grey[500] ),
                          ],
                        )
                      ),
                    ),
